    ...
    <div class="row">
      ...
      <div class="span12" style="min-height:300px;">
        ...
        <?php
          ...
          ?>
          <div class="span10">
          <form method="POST" id="usuarioalergiasForm" name="usuarioalergiasForm">
          ...
          <div class="form-actions">
            <button id="guardaralergias" class="btn btn-primary">Guardar</button>
          </div>
          <div class="span12">
            <div id="resultado">
            </div>
...
<script>
  !function ($) {
     $(function(){
            ...
            $("#usuarioalergiasForm").submit(function(){
              var tokenAlergias = $("input#tokenAlergias").val();
              var alergias = [];
              $(':checkbox:checked').each(function(i){
                alergias[i] = $(this).val();
              });
              $.post("registrar_alergias.php", {tokenAlergias:tokenAlergias,alergias:alergias}, 
                function(data){
                  $("select#tipoalimento option:selected").remove();
                  $("#tablaproductos").hide("slow");
                  $("#resultado").show("slow");
                  $("#resultado").html(data);
              });
              return false;
