...
esdiabetico('lisibonny@beato.com').esalergico('lisibonny@beato.com','Aceite de cacahuete').

esalergico('lisibonny@beato.com','Aceite de girasol').

esalergico('lisibonny@beato.com','Aceite de soja').

esalergico('lisibonny@beato.com','Mantequilla salada').

esalergico('lisibonny@beato.com','Tocino').

esalergico('lisibonny@beato.com','Harina integral').
