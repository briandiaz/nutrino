...
alimento(cereales,'Arroz blaco').
alimento(cereales,'Arroz integral').
...
%persona('jose','ismael','reyes','M','04/06/1989','210','5,8',3,[],S/N, , , ).

%crear predicado alergia
%crear predicado bebida que no le gusta
%crear predicado ultima compra: ultimacompra/2 ultimacompra(10,[arroz,papa,poyo]) o ultimacompra(10,arroz).
%																						 ultimacompra(10,papa).
%																						 ultimacompra(10,poyo).


persona('jose','ismael','reyes',10,'M','04/06/1989','210','5.8',3).
persona('jose','rafael','vargaz',11,'M','04/06/1989','200','5.8',4).
persona('brian','rafael','diaz',12,'M','04/06/2000','160','5.10',6).

% ---------------------------------Condiciones Especiales----------------------------------
esalergico(10,'Pina').
esalergico(10,'Camarones').
esalergico(10,'Kiwi').
esalergico(10,'Picante').
esalergico(10,'Azafran').
esalergico(10,'Laurel').

esdiabetico(1).
esdiabetico(11).

%--------------------------------Consumo de Lacteos----------------------------------
lacteosocacional(10,'Leche condensada').
lacteosocacional(10,'Leche en polvo').
lacteosocacional(10,'Queso cheddar').
lacteosocacional(10,'Queso Gouda').

lacteoscasinocome(10,'Leche de cabra').
lacteoscasinocome(10,'Queso Azul').
lacteoscasinocome(10,'Yogur entero').
lacteoscasinocome(10,'Yogur griego').

%---------------------------------Consumo de Huevos-----------------------------------
huevosocacional(10,'Huevo de codorniz').

huevoscasinocome(10,'Huevo de pato').

%---------------------------------Consumo de Azucares---------------------------------
azucaresocacional(10,'Chocolate').
azucaresocacional(10,'Chocolate blanco').
azucaresocacional(10,'Chocolate con leche').
azucaresocacional(10,'Miel').

azucarescasinocome(10,'Bombones').
azucarescasinocome(10,'Chocolate en polvo').

%---------------------------------Consumo de Aceites----------------------------------
aceitesocacional(10,'Aceite de coco').
aceitesocacional(10,'Aceite de girasol').

aceitescasinocome(10,'Aceite de soja').
aceitescasinocome(10,'Mantequilla salada').
aceitescasinocome(10,'Margarina').

%---------------------------------Consumo de Verduras---------------------------------
%revisar que pasa con las verduras
verdurasocacional(10,'Apio').
verdurasocacional(10,'Cebollino').
verdurasocacional(10,'Champinon').
verdurasocacional(10,'Coliflor').
verdurasocacional(10,'Espinaca').

verdurascasinocome(10,'Puerro').
verdurascasinocome(10,'Puerro en conserva').
verdurascasinocome(10,'Repollo').
verdurascasinocome(10,'Setas').
verdurascasinocome(10,'Remolacha en conserva').

%---------------------------------Consumo de Legumbres--------------------------------
legumbresocacional(10,'Frijol negro').
legumbresocacional(10,'Garbanzos').
legumbresocacional(10,'Guisantes congeladas').
legumbresocacional(10,'Alubias').

legumbrescasinocome(10,'Habas con vaina').
legumbrescasinocome(10,'Habas desgranadas').

%---------------------------------Consumo de Frutas----------------------------------
frutasocacional(10,'Pera').
frutasocacional(10,'Mora').
frutasocacional(10,'Pasa').
frutasocacional(10,'Ciruela').

frutascasinocome(10,'Picotas').
frutascasinocome(10,'Lima').

%---------------------------------Consumo de Blancas-----------------------------------
carnesblancasocacional(10,'Pato').
carnesblancasocacional(10,'Codorniz').
carnesblancasocacional(10,'Anguila').
carnesblancasocacional(10,'Breca').

carnesblancascasinocome(10,'Raya').
carnesblancascasinocome(10,'Reo').
carnesblancascasinocome(10,'Rodaballo').

%---------------------------------Consumo de Rojas-----------------------------------

carnesrojasocacional(10,'Bacon').
carnesrojasocacional(10,'Cabrito').
carnesrojasocacional(10,'Chicharrones').

carnesrojascasinocome(10,'Lacon').
carnesrojascasinocome(10,'Morcilla').
carnesrojascasinocome(10,'Sesos de cordero').

%-------------------------------------Mariscos---------------------------------------
mariscosocacional(10,'Langostino').
mariscosocacional(10,'Mejillon').
mariscosocacional(10,'Ostras').

mariscoscasinocome(10,'Sepia').
mariscoscasinocome(10,'Vieira').

%---------------------------------Consumo de Alcohol----------------------------------
alcoholocacional(10,'Cerveza').
alcoholocacional(10,'Cerveza baja en alcohol').
alcoholocacional(10,'Champan').
alcoholocacional(10,'Sangria').

alcoholcasinocome(10,'Tequila').
alcoholcasinocome(10,'Vermut').
alcoholcasinocome(10,'Vodka').

%---------------------------------Consumo de sin Alcohol------------------------------
sinalcoholocacional(10,'Tonica').
sinalcoholocacional(10,'Zumo de naranja').
sinalcoholocacional(10,'Zumo de uva').

sinalcoholcasinocome(10,'Horchata de chufa').
sinalcoholcasinocome(10,'Sorbete de limon').
sinalcoholcasinocome(10,'Zumo de melocoton').

% -------------------------------Consumo de Condimentos-------------------------------
condimentosocacional(10,'Caldo en cubitos').
condimentosocacional(10,'Chile picante').
condimentosocacional(10,'Mayonesa comercial').
condimentosocacional(10,'Nuez moscada').
condimentosocacional(10,'Vinagre').


condimentoscasinocome(10,'Salsa carbonara').
condimentoscasinocome(10,'Salsa holandesa').
condimentoscasinocome(10,'Salsa vinagreta').
condimentoscasinocome(10,'Tomate frito').

% --------------------------------Consumo de Cereales---------------------------------
cerealesocacional(10,'Avena').
cerealesocacional(10,'Pan integral de trigo').
cerealesocacional(10,'Macarrones').

cerealescasinocome(10,'Arros integral').
cerealescasinocome(10,'Galletas').

%---------------------------------Ultima Compra----------------------------------

ultimacompra(10,'Leche semidesnatada',3).
ultimacompra(10,'Queso morzzarella',2).
ultimacompra(10,'Yogur de sabores',5).
ultimacompra(10,'Huevo de gallina',24).
ultimacompra(10,'Azucar blanco',2).
ultimacompra(10,'Azucar moreno',2).
ultimacompra(10,'Chicle sin azucar',3).
ultimacompra(10,'Mermelada',2).
ultimacompra(10,'Aceite de oliva',1).
ultimacompra(10,'Aceite regular',1).
ultimacompra(10,'Mantequilla',1).
ultimacompra(10,'Ajo',2).
ultimacompra(10,'Batata',2).
ultimacompra(10,'Berenjena',3).
ultimacompra(10,'Cebolla',2).
ultimacompra(10,'Lechuga',2).
ultimacompra(10,'Pimiento morron',5).
ultimacompra(10,'Tomate',5).
ultimacompra(10,'Zanahoria',2).
ultimacompra(10,'Frijol rojo',2).
ultimacompra(10,'Garbanzos',2).
ultimacompra(10,'Arros blaco',5).
ultimacompra(10,'Harina',2).
ultimacompra(10,'Espaguetis',2).
ultimacompra(10,'Vino de mesa (tinto, blanco, rosado)',2).
ultimacompra(10,'Refrescos',1).
ultimacompra(10,'Te',5).
ultimacompra(10,'Canela molida',1).
ultimacompra(10,'Ketchup',2).
ultimacompra(10,'Sal fina de mesa',2).
ultimacompra(10,'Salami',1).
ultimacompra(10,'Pollo',1).
ultimacompra(10,'Pollo, pechuga',1).
ultimacompra(10,'Bacalao fresco',1).
ultimacompra(10,'Salmon',1).
ultimacompra(10,'Langosta',1).

%---------------------------------Recomendacion de Alimentos----------------------------------

%cambiar la vaida de las carnes
...
%recomienda los alimentos comidos ocacionalmente y casi no comidos.
...
%crea la lista para agregar los alimentos ocacionalmente consumidos
crearlista(ID,R,T) :-  alimento_oc(ID,L,T), alimento_no(ID,L2,T), append(L,L2,R).
alimento_oc(ID,L,T) :- atom_concat(T,ocacional,R), findall(F,call(R,ID,F), L).
