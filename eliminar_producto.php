...
<html lang="es">
  <head>
    ...
    <title>
      Elimina productos de tu lista de compras - Nutrino
    </title>
  ...
  !function ($) {
     $(function(){
            ...
            $('#agregarproductosForm').submit(function(){
              ...
              $.post("eliminar_producto_post.php", {listaproductos:listaproductos,correo:correo,producto:producto}, function(data){
